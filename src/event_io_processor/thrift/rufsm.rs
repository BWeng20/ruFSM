...
impl Event {
  pub fn new<F1>(name: F1) -> Event where F1: Into<Option<String>> {
    Event {
      name: name.into(),
    }
  }
...
pub struct EventProcessorSyncClient<IP, OP> where IP: TInputProtocol, OP: TOutputProtocol {
  _i_prot: IP,
  _o_prot: OP,
  _sequence_number: i32,
}

impl <IP, OP> EventProcessorSyncClient<IP, OP> where IP: TInputProtocol, OP: TOutputProtocol {
...
impl <IP, OP> TThriftClient for EventProcessorSyncClient<IP, OP> where IP: TInputProtocol, OP: TOutputProtocol {
