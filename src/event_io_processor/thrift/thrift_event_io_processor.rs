...
use thrift::protocol::{TBinaryInputProtocol, TBinaryOutputProtocol, TCompactInputProtocol, TCompactInputProtocolFactory, TCompactOutputProtocol};
...
use crate::event_io_processor::thrift::rufsm::{EventProcessorSyncClient , EventProcessorSyncHandler, EventProcessorSyncProcessor, TEventProcessorSyncClient};
...
pub struct MyServer {
    client: EventProcessorSyncClient<TCompactInputProtocol<TFramedReadTransport<
    ReadHalf<TTcpChannel>>>,TCompactOutputProtocol<TFramedWriteTransport<WriteHalf<TTcpChannel>>>>,
}
    ...
    pub fn new(execute_state: ExecutorStateArc) -> ThriftEventIOProcessor {
        ...
        match c.split() {
            Ok((i_chan, o_chan)) => {
                ...
                let mut client
                    = EventProcessorSyncClient::new(i_prot, o_prot);
